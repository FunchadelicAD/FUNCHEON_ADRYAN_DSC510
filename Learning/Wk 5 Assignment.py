...
while continue = true
    prompt user for what they want to do (add, subract, multiple, divide, average)

    if input from user = add
        call performCalculation and pass in operation
    if input from user = subtract
        call performCalculation and pass in operation
    if input from user = multiple
        call performCalculation and pass in operation
    if input from user = divide
        call performCalculation and pass in operation
    if input from user = average
        call calculateAverage
    else
        tell user they entered something incorrectly
